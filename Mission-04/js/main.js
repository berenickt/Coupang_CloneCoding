...
console.log(myCoupang.addEventListener('mouseenter', addActive));
...
function removeActive(e) {
  setTimeout(() => myCoupang.classList.remove('is--active'), 2000);
}
...
function removeEmpty(e) {
  setTimeout(() => cart.classList.remove('cart--empty'), 2000);
}
